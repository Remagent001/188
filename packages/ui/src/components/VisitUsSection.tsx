    ...
    <section className="relative bg-black overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-20">
        <div className="text-center mb-12">
          <p className="text-[#c9a96e] text-xs uppercase tracking-[0.4em] mb-3">Find Us</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
          ...
          <div className="space-y-3">
            <div className="w-10 h-10 border border-[#c9a96e] flex items-center justify-center mx-auto">
            ...
            <a
              ...
              className="text-white/70 text-sm leading-relaxed hover:text-[#c9a96e] transition-colors block"
            >
          ...
          <div className="space-y-3">
            ...
            <a
              href={`tel:${site.phone}`}
              className="text-white/70 text-sm hover:text-[#c9a96e] transition-colors block"
            >
              {site.phoneFormatted}
            </a>
            <div className="pt-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-[#c9a96e] hover:bg-[#b8924f] text-black font-bold uppercase tracking-widest px-8 py-3 text-xs transition-colors"
              >
                Book Now
              </a>
            </div>
