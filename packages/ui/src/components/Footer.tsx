          ...
          <div className="flex gap-4">
            {site.social.facebook && (
              <a href={site.social.facebook} target="_blank" rel="noopener noreferrer"
                className="hover:text-[#cc0000] transition-colors" aria-label="Facebook">
            ...
            {site.social.instagram && (
              <a href={site.social.instagram} target="_blank" rel="noopener noreferrer"
                className="hover:text-[#cc0000] transition-colors" aria-label="Instagram">
            ...
            {site.social.yelp && (
              <a href={site.social.yelp} target="_blank" rel="noopener noreferrer"
                className="hover:text-[#cc0000] transition-colors" aria-label="Yelp">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="space-y-6">
          <div>
            ...
            <a
              ...
              className="text-sm hover:text-[#cc0000] transition-colors leading-relaxed"
            >
              {site.address.street}{site.address.suite && `, ${site.address.suite}`}<br />
              {site.address.city}, {site.address.state} {site.address.zip}
            </a>
            <div className="mt-2">
              <a href={`tel:${site.phone}`} className="text-sm hover:text-[#cc0000] transition-colors">
                {site.phoneFormatted}
              </a>
            </div>
          </div>
          <div>
            ...
            <ul className="space-y-1.5 text-sm">
              {[
                ...
                <li key={href}>
                  <a href={href} className="hover:text-[#cc0000] transition-colors">{label}</a>
                </li>
              ))}
            </ul>
          </div>
