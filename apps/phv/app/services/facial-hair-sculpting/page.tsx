  ...
  return (
    <>
      ...
      <section className="bg-[#f5f5f5] pt-24 pb-16 px-4 text-center">
        ...
        <h1 className="text-[#212934] text-4xl sm:text-5xl font-bold mb-4">Facial Hair Sculpting</h1>
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-10 border border-[#aa0000]/20 p-6 bg-[#f5f5f5] text-center">
