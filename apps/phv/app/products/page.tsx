...
export const metadata = {
  ...
  description:
    "Professional men's grooming products available at 18|8 Preston Hollow Village. Reuzel, 18.21 Man Made, and STMNT Grooming Goods — hand-selected by our stylists.",
};
    ...
    <>
      ...
      <section className="bg-[#111] py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-white text-2xl sm:text-3xl font-bold mb-4">Not Sure What You Need?</h2>
      ...
      <BookingCTA
        ...
        subtext="Visit us at Preston Hollow Village to browse our full product selection and get expert recommendations from your stylist."
      />
    </>
  );
}
