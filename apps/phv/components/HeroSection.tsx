...
export function HeroSection({ site }: HeroSectionProps) {
  return (
    <section className="relative min-h-screen flex items-end bg-white overflow-hidden">
      {/* Background photo — man on left, whitespace on right */}
      <div
      ...
      {/* Content — right side */}
      <div className="relative z-10 w-full flex justify-end px-8 sm:px-16 pb-20 sm:pb-28">
        <div className="max-w-lg text-right">

          <h1 className="text-[#aa0000] text-4xl sm:text-[3.5rem] md:text-[4rem] font-bold uppercase leading-none mb-4"
