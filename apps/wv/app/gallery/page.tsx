...
export const metadata = {
  ...
  description: "Photos from 18|8 Fine Men's Salon Uptown – West Village Dallas.",
};

export default function GalleryPage() {
  return (
    <section className="bg-black pt-24 pb-16 px-4 text-center min-h-screen">
      <p className="text-[#aa0000] text-xs uppercase tracking-[0.4em] mb-3">Our Work</p>
      <h1 className="text-white text-4xl sm:text-5xl font-bold mb-4">Gallery</h1>
