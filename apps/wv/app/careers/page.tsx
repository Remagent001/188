...
export const metadata = {
  title: "Careers | 18|8 Fine Men's Salon Uptown – West Village | Dallas, TX",
  description:
    "Join the team at 18|8 Fine Men's Salon Uptown – West Village in Dallas. We're looking for talented hairstylists, barbers, and front desk professionals.",
};
