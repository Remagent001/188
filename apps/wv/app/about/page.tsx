...
export const metadata = {
  ...
  description:
    "Learn about 18|8 Fine Men's Salon Uptown – West Village in Dallas. Our story, our mission, and the team behind the experience.",
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <div className="space-y-5 text-white/60 text-sm leading-relaxed">
                ...
                <p>
                  At our Uptown – West Village location, we've created a space designed exclusively
