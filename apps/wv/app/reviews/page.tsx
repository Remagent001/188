...
export const metadata = {
  ...
  description:
    "Read what clients are saying about 18|8 Fine Men's Salon Uptown – West Village in Dallas. Leave a review on Google or Yelp.",
};
    ...
    <>
      ...
      <section className="bg-black pt-24 pb-16 px-4 text-center">
        ...
        <p className="text-white/50 text-sm mt-6 max-w-xl mx-auto leading-relaxed">
          We let our work and our clients speak for us. Read what the gentlemen of Dallas's West
          Village have to say about their experience at 18|8.
        </p>
      </section>
      ...
      <section className="bg-[#111] py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/60 text-sm leading-relaxed mb-10 max-w-xl mx-auto">
            If you've visited 18|8 Uptown – West Village, we'd love to hear from you. Your feedback
      ...
      <BookingCTA
        ...
        subtext="Join the many gentlemen who make 18|8 Uptown their grooming destination."
      />
    </>
  );
}
